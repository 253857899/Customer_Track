...
<form class="layui-form" lay-filter="myform" action="../Src"> 
<c:if test="${param.id!=null}">
<input type="hidden" name="id" value="${param.id }">
<input type="hidden" name="_method" value="put">
</c:if>
	<div class="layui-form-item">
    <label class="layui-form-label">客户来源编号</label>
    <div class="layui-input-block">
      <input type="text" name="id" <c:if test="${param.id!=null}">disabled="disabled"</c:if> autocomplete="off" placeholder="请输入来源编号" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">客户来源名称</label>
    <div class="layui-input-block">
      <input type="text" name="name"  autocomplete="off" placeholder="请输入来源名称" class="layui-input">
    </div>
  </div>
...
function init(){
	$.post("../Src/"+id,{_method:"get"}, function(json) {
		render('myform', json);
	},"json");
