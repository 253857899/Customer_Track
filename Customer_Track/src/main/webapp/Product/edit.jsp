...
<form class="layui-form" lay-filter="myform" action="../Product"> 
...
<input type="hidden" name="_method" value="put">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="amount"  autocomplete="off" placeholder="请输入产品单价" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
...
function init(){
	$.post("../Product/"+id,{_method:"get"}, function(json) {
		render('myform', json);
	},"json");
